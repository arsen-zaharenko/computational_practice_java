...
public class Main {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        Task.add(sheetsService, SPREADSHEET_ID, new Student("Michael","Male","1. Freshman","NY","IT","Cricket"));
        Task.add(sheetsService, SPREADSHEET_ID, new Student("Angela","Female","2. Sophomore","WI","Biology","Swimming"));
